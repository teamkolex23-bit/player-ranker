...
# First Starting XI
st.markdown(
    f'<div style="font-size:20px; font-weight:bold">🛈 <span title="{info_text}">First Starting XI</span></div>',
    unsafe_allow_html=True
)
...
# Second Starting XI
st.markdown(
    f'<div style="font-size:20px; font-weight:bold">🛈 <span title="{info_text}">Second Starting XI</span></div>',
    unsafe_allow_html=True
)
